...
app.listen(PORT, () => { console.log(`\nÃÂ°ÃÂÃÂÃÂ Bol.com Retailer MCP Server running on http://localhost:${PORT}`); console.log(`   MCP endpoint: http://localhost:${PORT}/mcp\n`); });
