/**
 * FiveX MCP Server ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Remote Streamable HTTP transport
 *
 ...
 *   Settings ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Connectors ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Add custom connector ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ paste URL
 */
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Config ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Session management ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
Currency is EUR. Use Dutch notation (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ 1.234,56).
...
app.listen(PORT,()=>{console.log(`\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ FiveX MCP Server running on http://localhost:${PORT}`);console.log(`   MCP endpoint: http://localhost:${PORT}/mcp\n`)});
